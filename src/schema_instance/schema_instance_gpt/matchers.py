...
from schema_instance.schema_instance_gpt.cross_domain_embeddings import (
    get_embedding_hf,
    get_embedding_openai,
)
from schema_instance.schema_instance_gpt.generator import (
...
def validate_rule(
    ...
    with open(
        "./src/schema_instance/schema_instance_gpt/rules.py",
        "r",
    ) as file:
        content = file.read()
    ...
    rules = importlib.import_module("src.schema_instance.schema_instance_gpt.rules")
